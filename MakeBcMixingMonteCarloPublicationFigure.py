"""Create the publication-quality momentum-space Monte Carlo histogram."""
...
PRODUCTION_SAMPLES = ROOT / "BcMixingMonteCarloSamplesPublication.csv"
FALLBACK_SAMPLES = ROOT / "BcMixingMonteCarloSamples.csv"
...
def main() -> None:
    ...
    pdf_path = OUTPUT_DIR / "BcMixingMonteCarloHistogramPublication.pdf"
    png_path = PREVIEW_DIR / "BcMixingMonteCarloHistogramPublication.png"
